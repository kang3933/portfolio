...
export default function Home() {
    ...
    <main className="w-full bg-white flex font-[Pretendard] flex-col items-center overflow-hidden">
      ...
      <section className="w-full bg-[#F5F5F5] p-[5%] flex justify-center">
        <div className="w-full flex flex-col gap-[3rem]">
          ...
          {/* 섹션 헤더 */}
          <div className="flex flex-col gap-4">
            <div className="text-[#131313] font-[Pretendard]">
              <div className="text-4xl font-bold">New Website,<br />New Standard</div>
              <div className="text-2xl text-[#A9A9A9] font-semibold">솔루션 1 : 디자인 가이드라인</div>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row justify-between gap-[3rem]">

            {/* 카드 1 */}
            <div className="w-full sm:w-[40%] bg-white p-[5%] rounded-[1rem] flex flex-col shadow-md">
              <div className="flex flex-col sm:flex-col items-center justify-between gap-[2rem]">
                <div className="w-full text-[1.5rem] font-bold">
                  일관된 디자인 시스템, <br /> 브랜드 통일성 확보.
                </div>

                <div className="flex flex-col sm:flex-row w-full justify-between gap-8">
                  <div className="fontOne">
                    <div>HEADING TYPOGRAPHY</div>
              ...
              {/* 카드 3 */}
              <div className="w-full bg-white p-[5%] rounded-[1rem] flex flex-col justify-between items-center gap-[2rem] shadow-md">
                <div className="w-full text-[1.5rem] font-bold">
                  브랜드 컬러 그대로, <br /> 신뢰와 일관성을 담다.
                </div>
                <div className="w-full">
                  <img src="/mockup/peninsula/color.png" alt="Brand color system" className="w-full rounded-md" />
                </div>
              </div>
        </div>
              {/* 카드 2 */}
              <div className="w-full bg-white p-[5%] rounded-[1rem] flex flex-col sm:flex-row justify-between items-center gap-[5%] shadow-md">
                <div className="w-full sm:w-[45%] text-[1.5rem] font-bold">
                  정렬된 그리드, 균형 잡힌 디자인.
                </div>
                <div className="w-full sm:w-[53%]">
                  <img src="/mockup/peninsula/grid.png" alt="Grid system" className="w-full rounded-md" />
                </div>
              </div>
      ...
      <section className="w-full pb-[250px] flex flex-col items-left justify-center">
        

        <div className="p-[5%] flex flex-col gap-5">
          <div className="text-5xl font-bold flex">Simplify to Amplify</div>
          <div className="text-2xl text-[#A9A9A9] font-semibold flex">솔루션 2 : 정보 구조 최적화</div>
        </div>

        
        <div className="flex flex-row justify-between items-center pl-[5%] pr-[5%] pb-[5%]">
      ...
      <section className="w-full bg-[#F5F5F5] p-[5%] flex flex-col justify-center items-center">

          <div className="flex flex-col w-full justify-center pb-[3rem]">
  ...
  <div className="flex flex-row sm:flex-col w-full gap-[3rem]">

    {/* 기존 웹사이트 */}
    <div className="w-full lg:w-1/2 flex flex-col pb-[3rem] justify-between items-center">
      <div className="w-full flex flex-col">
        <div className="text-[#A9A9A9] text-2xl font-semibold pb-4">기존 웹사이트</div>
    ...
    <div className="w-full lg:w-1/2 flex flex-col pb-[3rem] justify-between items-center">
      <div className="w-full flex flex-col">
        <div className="text-[#A9A9A9] text-2xl font-semibold pb-4">Revision 1</div>
        <div className="gap-1 text-[#131313] font-semibold">
          동일한 강조색은 주목도 분산.<br />
          강조할 내용은 크게.
        </div>
  ...
  <div className="flex flex-row sm:flex-col w-full gap-[3rem]">
    ...
    <div className="w-full lg:w-1/2 flex flex-col pb-[3rem] justify-between items-center">
      <div className="w-full flex flex-col">
        <div className="text-[#A9A9A9] text-2xl font-semibold pb-4">Revision 2</div>
        <div className="gap-1 text-[#131313] font-semibold">
    ...
    <div className="w-full lg:w-1/2 flex flex-col pb-[3rem] justify-between items-center">
      <div className="w-full flex flex-col">
        <div className="text-[#A9A9A9] text-2xl font-semibold pb-4">최종 디자인</div>
        <div className="gap-1 text-[#131313] font-semibold">
      ...
      <section className="w-full flex flex-col bg-[#FFFFFF] p-[5%] justify-center items-center">
      ...
      <div className="flex flex-row justify-between items-center w-full max-w-[1300px]">
        ...
        <Image
          src="/mockup/peninsula/m11.png"
          alt="Peninsula mockup image"
          width={400} // 실제 원본 이미지 너비에 맞춰서 조정 (대략적인 값)
          height={300} // 비율에 맞게 설정 (원본에 맞게 조절)
