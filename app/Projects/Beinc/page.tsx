...
export default function Home() {
  ...
  const asIsItems = [
    {
      ...
      content: (
        ...
        <ul className="list-disc pl-5">
          <li>Beinc가 제공하는 서비스에 대한 명확한 설명이 부족하여 방문자가 어떤 디자인 솔루션을 제공하는지 이해하기 어려웠어요.</li>
          <li>CTA가 제대로 갖춰져 있지 않아서 목적성이 불분명한 웹사이트가 되었어요.</li>
        </ul>
    ...
    },
    {
      ...
      content: (
        ...
        <ul className="list-disc pl-5">
          <li>복잡한 화면 구성으로 인해 사용자 경험이 저하되었으며, 정보 전달력이 떨어졌어요.</li>
          <li>심플하고 직관적인 디자인 요소가 부족하여 시각적 집중도가 낮았어요.</li>
        </ul>
    ...
    },
    {
      ...
      content: (
        ...
        <ul className="list-disc pl-5">
          <li>웹사이트의 콘텐츠 업데이트 및 수정이 비효율적으로 이루어져 유지보수가 어려운 상태였어요.</li>
          <li>일관성 있는 콘텐츠 디자인이 적용되지 않아 브랜드 아이덴티티 유지가 어렵고 콘텐츠 제작에 너무 많은 시간이 들었어요.</li>
        </ul>
  ...
  return (
    <main className="w-full bg-[#131313] flex font-[pretendard] flex-col items-center">

      <div className="pt-[4rem] w-full pb-0 flex justify-center items-center overflow-hidden">
        <img className="h-[90vh] w-screen object-cover" src="/mockup/beinc/main.png"/>
      </div>

      <div className="w-full bg-[#131313] pl-[5%] pr-[5%] pt-[200px] pb-[200px] m-0 flex justify-center">
        <div className="max-w-[1300px] flex flex-row justify-between w-full">
          <div className='projectDetail w-[50%] '>
            <h1 className="text-[#F5F5F5]">Beinc</h1>
            <h5 className="text-base text-[#F5F5F5]">UI/UX Design / Development</h5>
          </div>

          <div className='projectDetail w-[50%]'>
            <h5 className="text-base font-normal text-[#F5F5F5]">Beinc 웹사이트 디자인 프로젝트는 기존의 복잡하고 노후된 웹사이트를 보다 심플하면서도 강렬한 브랜드 아이덴티티를 전달할 수 있도록 재구성하는 데 중점을 두었습니다.
디자인 에이전시로서 Beinc의 서비스와 역량을 명확하게 전달하고, 포트폴리오를 효과적이고 인상적으로 showcasing하는 것이 이번 프로젝트의 핵심 목표였습니다.
이를 통해 방문자에게 직관적인 사용자 경험을 제공하고, 잠재 고객의 유입 및 문의를 극대화하는 것을 목표로 설정했습니다.</h5>
          </div>
        </div>
      </div>
      ...
      <section className="w-full max-w-[100%] bg-[#151515] p-[5%] flex justify-center items-center h-[100vh]">
